...
print("Path directory:", os.getcwd())
...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.pushButton_5.clicked.connect(self.push_Settings_clicked)    
    ...
    def push_Settings_clicked(self):
        # self.openWindow()                     # mainwindow4.py, class Ui_MainWindow, method openWindow  the UiDialog imported from settings.py 
        # self.setupUiDialog(self)
        # Question!  Why didn`t work this??
        # kaupunki = self.lineEdit_city.text()
        # print(kaupunki)
        pass
