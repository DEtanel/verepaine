...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def push_Settings_clicked(self):
        self.openWindow()
        # self.setupUi.lineEdit_city  !!!!!!!!!!!!!! Error !!!!!!!
    ...
    def push_Bloodpressure_clicked(self):
        ...
        ax2.plot(dates, values_dia2, color='g', label='Dia')     # x-axis =Date  y-axis = DIA
        ax2.set_ylabel('DIA')

        ax3 = ax.twinx()
        ax3.plot(dates, values_pulse3, label='Pulse', color='blue')
